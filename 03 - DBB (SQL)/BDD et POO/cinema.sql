...
--
-- Chargement des données de la table `cinema`
--
...
--
-- chargement des données de la table `film`
--
...
--
-- chargement des données de la table `seance`
--
...
--
ALTER TABLE `cinema`
  MODIFY `idCinema` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `film`
--
ALTER TABLE `film`
  MODIFY `idFilm` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `seance`
--
ALTER TABLE `seance`
  MODIFY `idSeance` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
